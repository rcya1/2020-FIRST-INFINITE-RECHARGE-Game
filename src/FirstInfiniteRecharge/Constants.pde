...
final short CATEGORY_GOAL = 0x0010;
...
final short MASK_CELL_AIRBORNE =  CATEGORY_BOUNDARY | CATEGORY_CELL_AIRBORNE | CATEGORY_GOAL;
final short MASK_GOAL = CATEGORY_CELL_AIRBORNE;
